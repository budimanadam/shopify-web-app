...
// Note: the file is separated since it will be used to get single product by productID

// Set the URL of the REST API
$apiUrl = "https://sanda-dev.myshopify.com/admin/api/2024-10/products/" . $_GET['id'] . ".json";
